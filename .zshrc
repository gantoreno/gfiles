...
# zstyle ':omz:update' mode reminder  # just remind me to update when it'sexit time
...
# Don't like the original $LSCOLORS?
...
# Place below user configuration, like exports, evals, and extra
# elements that belong solely to the user and can be changed further
# in the future.
eval $(fnm env)
