...
set -g window-status-format         "#[fg=colour0]#[bg=colour0]#{@left_separator}#[fg=#5b5f71,nobold]#[bg=olour0] הּ גּ #I #{@left_alt_separator} #W #[bg=colour0]#[fg=colour0]#{@left_separator}"
set -g window-status-current-format "#[fg=colour0,bold]#[bg=colour12]#{@left_separator}#[fg=colour0]#[bg=colour12] הּ גּ #I #{@left_alt_separator} #W #[fg=colour12]#[bg=colour0]#{@left_separator}"
