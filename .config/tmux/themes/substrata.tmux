...
set -g window-status-format         "#[fg=colour0]#[bg=colour0]#{@left_separator}#[fg=#5b5f71,nobold]#[bg=colour0]  #I #{@left_alt_separator} #W #[bg=colour0]#[fg=colour0]#{@left_separator}"
